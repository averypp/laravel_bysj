 ...
 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @param  {Function} callback a function to be called once the text box is blurred, it is called in the instance's scope and receives the node, a status parameter (true if the rename is successful, false otherwise) and a boolean indicating if the admin cancelled the edit. You can access the node's title using .text
		 */
 ...
 *
 * This plugin allows defining a callback to allow or deny node selection by admin input (activate node method).
 */
 ...
 */
	...
	$.jstree.defaults.dnd = {
		...
		is_draggable : true,
		/**
		 * a boolean indicating if checks should constantly be made while the admin is dragging the node (as opposed to checking only on drop), default is `true`
