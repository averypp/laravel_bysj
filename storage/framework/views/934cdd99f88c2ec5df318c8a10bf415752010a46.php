...
<?php $__env->startSection('my_js'); ?>
    ...
    <script type="text/javascript">
        function detail(id) {
            if (id > 0){
                $.post('<?php echo e(url('/Manage/DemandList/getDetail')); ?>',{id:id}, function (_response) {
    ...
    <script type="text/javascript">
        ...
        function examine(_obj,id,status) {
            ...
            if (remark != null){
                ...
                $.post('<?php echo e(url('/Manage/DemandList/examine')); ?>',{id:id, status:status,remark:remark}, function (_response) {
                    if (_response.status == 1){
                        op = status==1 ? '通过' : '不通过';
        ...
        $(function () {
            $('#export').click(function () {
                $('#myFormId').attr("action", "<?php echo e(url('/Manage/DemandList/export')); ?>");
            });
            $('#submit').click(function () {
                $('#myFormId').attr("action", "");
            });
        ...
        function doSign(_obj,id) {
            $.post('<?php echo e(url('/Manage/DemandList/doSign')); ?>',{id:id}, function (_response) {
                if (_response.status == 1){
