...
use App\Model\Demand\DemandOrder;
...
class DemandOrderController extends BaseController
{
    
    public $layout = 'demandOrder';
    protected $module = 'DemandOrder';
    public $model;
    public $statusArr = [
            '0'=>'等待接单',
            '1'=>'拒绝接单',
