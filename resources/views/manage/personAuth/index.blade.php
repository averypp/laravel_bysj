                    ...
                    <div class="ibox-title">
                        ...
                        @if(in_array('add',$option))
                            <div class="ibox-tools">
                                <a href="{{ url('Manage/personAuth/add') }}" class="collapse-link btn btn-info my-inline">
    ...
    <script type="text/javascript">
        ...
        function examine(_obj,id,status) {
            ...
            if (remark != null){
                ...
                $.post('{{ url('/Manage/PersonAuth/examine') }}',{id:id, status:status,remark:remark}, function (_response) {
                    if (_response.status == 1){
                        op = status==1 ? '通过' : '不通过';
